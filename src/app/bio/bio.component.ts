...
export class BioComponent implements OnInit {
  ...
  bio = 'Hi there, my name is Samin Azhan.' +
    ...
    ' I love working with frameworks such as front-end: Angular (Typescript), back-end: Sprint Boot (Java), Django (Python), databases: Oracle, PostgreSQL, Firebase, MongoDB and REST APIs.' +
    ' I am also experienced in using Test Automation tools such as JUnit, Cucumber, REST-assured, Selenium, WebdriverIO and have developed projects using Test-driven development (TDD) and behavior-driven development (BDD) in an Agile environment.' +
